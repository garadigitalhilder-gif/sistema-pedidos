...
exports.ejecutarLimpiezaHistorial = ejecutarLimpiezaHistorial;
exports.inicializarCronLimpieza = inicializarCronLimpieza;
...
async function ejecutarLimpiezaHistorial() {
    ...
    try {
        ...
        const pedidosEliminados = await db_1.default.pedido.deleteMany({
            where: {
                deletedAt: {
                    lt: fechaLimite
                }
        ...
        const clientesEliminados = await db_1.default.cliente.deleteMany({
            where: {
                deletedAt: {
                    lt: fechaLimite
                }
        ...
        const pedidosEntregadosViejos = await db_1.default.pedido.deleteMany({
            where: {
                createdAt: {
                    lt: fechaLimite
                },
        ...
        console.log(`[Limpieza] Mantenimiento completado con éxito: ` +
 ...
 */
function inicializarCronLimpieza() {
